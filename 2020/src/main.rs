...
fn main() {
    ...
    match day {
        ...
        15 => {
            println!("Day15 p1: {:?}", day15::part_one());
            println!("Day15 p2: {:?}", day15::part_two());
        }
        16 => {
            println!("Day16 p1: {:?}", day16::part_one());
            println!("Day16 p2: {:?}", day16::part_two());
        }
        17 => {
            println!("Day17 p1: {:?}", day17::part_one());
            println!("Day17 p2: {:?}", day17::part_two());
        }
